...
public class Permissions {
    ...
    public static class Overwrite extends Snowflake {
        ...
        public static Overwrite findBySnowflake(ArrayList<Overwrite> overwrites, Snowflake snowflake) {
        ...
        public Overwrite findBySnowflake(ArrayList<Overwrite> overwrites, long snowflake) {
            for (Overwrite overwrite : overwrites) {
