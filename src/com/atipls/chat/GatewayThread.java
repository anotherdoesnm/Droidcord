...
public class GatewayThread extends Thread {
    ...
    private com.atipls.chat.State s;
    ...
    public GatewayThread(com.atipls.chat.State s, String gateway, String token) {
        this.s = s;
        ...
        s.subscribedGuilds = new ArrayList<Guild>();
    }
    ...
    public void disconnected(String message) {
        ...
        s.gateway.start();
        Log.w("GatewayThread", "Disconnected: " + message);
    }
    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                Log.d("GatewayThread", "Received message: " + op + " - " + message.toString());
